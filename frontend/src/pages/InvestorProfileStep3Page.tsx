...
import type {
  ...
  InvestorProfileStepThreeQuestionId,
  InvestorProfileStepThreeResponse,
  InvestorProfileStepThreeUpdateRequest
} from '../types/api';
...
function createEmptyStep3Fields(): InvestorProfileStepThreeFields {
  ...
  ) as InvestorProfileStepThreeFields['investmentKnowledge']['byType'];
...
const QUESTION_CONFIG: Partial<
  Record<InvestorProfileStepThreeQuestionId, InvestorProfileStepThreeQuestionConfig>
> = {
  'step3.holder.kind': {
    key: 'step3.holder.kind',
    title: 'Is the primary account holder a person or an entity?',
  ...
  'step3.holder.contact.email': {
    key: 'step3.holder.contact.email',
  ...
  'step3.holder.contact.phones': {
    key: 'step3.holder.contact.phones',
  ...
  'step3.holder.contact.phones.home': {
    key: 'step3.holder.contact.phones.home',
  ...
  'step3.holder.contact.phones.business': {
    key: 'step3.holder.contact.phones.business',
  ...
  'step3.holder.contact.phones.mobile': {
    key: 'step3.holder.contact.phones.mobile',
  ...
  'step3.holder.legalAddress.city': {
    key: 'step3.holder.legalAddress.city',
  ...
  'step3.holder.legalAddress.stateProvince': {
    key: 'step3.holder.legalAddress.stateProvince',
  ...
  'step3.holder.legalAddress.postalCode': {
    key: 'step3.holder.legalAddress.postalCode',
  ...
  'step3.holder.mailingAddress.city': {
    key: 'step3.holder.mailingAddress.city',
    title: 'Mailing city?',
  ...
  'step3.holder.mailingAddress.stateProvince': {
    key: 'step3.holder.mailingAddress.stateProvince',
  ...
  'step3.holder.mailingAddress.postalCode': {
    key: 'step3.holder.mailingAddress.postalCode',
  ...
  'step3.holder.maritalStatus': {
    key: 'step3.holder.maritalStatus',
  ...
  'step3.holder.employment.status': {
    key: 'step3.holder.employment.status',
  ...
  'step3.holder.employment.occupation': {
    key: 'step3.holder.employment.occupation',
    title: 'Occupation?',
  ...
  'step3.holder.employment.employerName': {
    key: 'step3.holder.employment.employerName',
    title: 'Employer name?',
  ...
  'step3.holder.employment.employerAddress.line1': {
    key: 'step3.holder.employment.employerAddress.line1',
  ...
  'step3.holder.employment.employerAddress.city': {
    key: 'step3.holder.employment.employerAddress.city',
    title: 'Employer city?',
    helper: 'Enter city.',
    type: 'text',
    placeholder: 'City'
  ...
  'step3.holder.employment.employerAddress.stateProvince': {
    key: 'step3.holder.employment.employerAddress.stateProvince',
  ...
  'step3.holder.employment.employerAddress.postalCode': {
    key: 'step3.holder.employment.employerAddress.postalCode',
  ...
  'step3.holder.employment.employerAddress.country': {
    key: 'step3.holder.employment.employerAddress.country',
    title: 'Employer country?',
    helper: 'Select one country code.',
    type: 'country-multi'
  },
  'step3.investment.knowledgeExperience': {
    key: 'step3.investment.knowledgeExperience',
  ...
  'step3.investment.generalKnowledge': {
    key: 'step3.investment.generalKnowledge',
  ...
  'step3.investment.byType.other.label': {
    key: 'step3.investment.byType.other.label',
  ...
  'step3.financial.taxBracket': {
    key: 'step3.financial.taxBracket',
  ...
  'step3.disclosure.employeeAdvisorFirm': {
    key: 'step3.disclosure.employeeAdvisorFirm',
  ...
  'step3.disclosure.relatedAdvisorFirmEmployee': {
    key: 'step3.disclosure.relatedAdvisorFirmEmployee',
  ...
  'step3.disclosure.employeeBrokerDealer': {
    key: 'step3.disclosure.employeeBrokerDealer',
  ...
  'step3.disclosure.relatedBrokerDealerEmployee': {
    key: 'step3.disclosure.relatedBrokerDealerEmployee',
  ...
  'step3.disclosure.maintainsOtherBrokerageAccounts': {
    key: 'step3.disclosure.maintainsOtherBrokerageAccounts',
  ...
  'step3.disclosure.exchangeOrFinraAffiliation': {
    key: 'step3.disclosure.exchangeOrFinraAffiliation',
    title:
  ...
  'step3.disclosure.seniorOfficerDirectorTenPercentPublicCompany': {
    key: 'step3.disclosure.seniorOfficerDirectorTenPercentPublicCompany',
...
for (const investmentType of INVESTMENT_TYPES) {
  QUESTION_CONFIG[`step3.investment.byType.${investmentType.key}.knowledge`] = {
    key: `step3.investment.byType.${investmentType.key}.knowledge`,
  ...
  QUESTION_CONFIG[`step3.investment.byType.${investmentType.key}.sinceYear`] = {
    key: `step3.investment.byType.${investmentType.key}.sinceYear`,
...
function findQuestionIndex(
  currentQuestionId: InvestorProfileStepThreeQuestionId | null,
  visible: InvestorProfileStepThreeQuestionId[]
): number {
...
function getErrorForQuestion(
  ...
  if (questionId === 'step3.investment.knowledgeExperience') {
    const investmentErrorKey = Object.keys(fieldErrors).find((key) => key.startsWith('step3.investment.'));
...
function setSingleChoice(
  ...
  if (questionId === 'step3.holder.kind') selectOne(next.holder.kind, selectedKey);
  if (questionId === 'step3.holder.taxId.hasEin') selectOne(next.holder.taxId.hasEin, selectedKey);
  if (questionId === 'step3.holder.mailingDifferent') selectOne(next.holder.mailingDifferent, selectedKey);
  if (questionId === 'step3.holder.gender') selectOne(next.holder.gender, selectedKey);
  if (questionId === 'step3.holder.maritalStatus') selectOne(next.holder.maritalStatus, selectedKey);
  if (questionId === 'step3.holder.employment.status') selectOne(next.holder.employment.status, selectedKey);
  if (questionId === 'step3.investment.generalKnowledge') selectOne(next.investmentKnowledge.general, selectedKey);
  if (questionId === 'step3.financial.taxBracket') selectOne(next.financialInformation.taxBracket, selectedKey);
  if (questionId === 'step3.disclosure.employeeAdvisorFirm') selectOne(next.affiliations.employeeAdvisorFirm, selectedKey);
...
function getAnswer(fields: InvestorProfileStepThreeFields, questionId: InvestorProfileStepThreeQuestionId): unknown {
  switch (questionId) {
...
function applyAnswer(
  ...
  if (questionId === 'step3.holder.name') next.holder.name = String(answer ?? '');
  if (questionId === 'step3.holder.taxId.ssn') next.holder.taxId.ssn = String(answer ?? '');
  if (questionId === 'step3.holder.taxId.ein') next.holder.taxId.ein = String(answer ?? '');
  if (questionId === 'step3.holder.contact.email') next.holder.contact.email = String(answer ?? '');
  if (questionId === 'step3.holder.contact.dateOfBirth') next.holder.contact.dateOfBirth = String(answer ?? '');
  if (questionId === 'step3.holder.contact.specifiedAdult') next.holder.contact.specifiedAdult = String(answer ?? '');
  if (questionId === 'step3.holder.contact.phones') {
    next.holder.contact.phones = answer as InvestorProfileStepThreeFields['holder']['contact']['phones'];
  }
  if (questionId === 'step3.holder.contact.phones.home') next.holder.contact.phones.home = String(answer ?? '');
  if (questionId === 'step3.holder.contact.phones.business') next.holder.contact.phones.business = String(answer ?? '');
  if (questionId === 'step3.holder.contact.phones.mobile') next.holder.contact.phones.mobile = String(answer ?? '');
  if (questionId === 'step3.holder.legalAddress') {
    next.holder.legalAddress = answer as InvestorProfileStepThreeFields['holder']['legalAddress'];
  }
  if (questionId === 'step3.holder.legalAddress.line1') next.holder.legalAddress.line1 = String(answer ?? '');
  if (questionId === 'step3.holder.legalAddress.city') next.holder.legalAddress.city = String(answer ?? '');
  if (questionId === 'step3.holder.legalAddress.stateProvince') next.holder.legalAddress.stateProvince = String(answer ?? '');
  if (questionId === 'step3.holder.legalAddress.postalCode') next.holder.legalAddress.postalCode = String(answer ?? '');
  if (questionId === 'step3.holder.mailingAddress') {
    next.holder.mailingAddress = answer as InvestorProfileStepThreeFields['holder']['mailingAddress'];
  }
  if (questionId === 'step3.holder.mailingAddress.line1') next.holder.mailingAddress.line1 = String(answer ?? '');
  if (questionId === 'step3.holder.mailingAddress.city') next.holder.mailingAddress.city = String(answer ?? '');
  if (questionId === 'step3.holder.mailingAddress.stateProvince') next.holder.mailingAddress.stateProvince = String(answer ?? '');
  if (questionId === 'step3.holder.mailingAddress.postalCode') next.holder.mailingAddress.postalCode = String(answer ?? '');
  if (questionId === 'step3.holder.employment.occupation') next.holder.employment.occupation = String(answer ?? '');
  if (questionId === 'step3.holder.employment.yearsEmployed') {
    next.holder.employment.yearsEmployed = answer === '' || answer === null ? null : Number(answer);
  }
  if (questionId === 'step3.holder.employment.typeOfBusiness') next.holder.employment.typeOfBusiness = String(answer ?? '');
  if (questionId === 'step3.holder.employment.employerName') next.holder.employment.employerName = String(answer ?? '');
  if (questionId === 'step3.holder.employment.employerAddress.line1') next.holder.employment.employerAddress.line1 = String(answer ?? '');
  if (questionId === 'step3.holder.employment.employerAddress.city') next.holder.employment.employerAddress.city = String(answer ?? '');
  if (questionId === 'step3.holder.employment.employerAddress.stateProvince') next.holder.employment.employerAddress.stateProvince = String(answer ?? '');
  if (questionId === 'step3.holder.employment.employerAddress.postalCode') next.holder.employment.employerAddress.postalCode = String(answer ?? '');
  if (questionId === 'step3.investment.byType.other.label') next.investmentKnowledge.byType.other.label = String(answer ?? '');

  if (questionId === 'step3.holder.legalAddress.country') {
    const list = answer as string[];
    next.holder.legalAddress.country = list[0] ?? null;
  }
  if (questionId === 'step3.holder.mailingAddress.country') {
    const list = answer as string[];
    next.holder.mailingAddress.country = list[0] ?? null;
  }
  if (questionId === 'step3.holder.citizenship.primary') next.holder.citizenship.primary = answer as string[];
  if (questionId === 'step3.holder.citizenship.additional') next.holder.citizenship.additional = answer as string[];
  if (questionId === 'step3.holder.employment.employerAddress.country') {
    const list = answer as string[];
    next.holder.employment.employerAddress.country = list[0] ?? null;
  }

  if (questionId === 'step3.financial.annualIncomeRange') {
    next.financialInformation.annualIncomeRange = answer as InvestorProfileStepThreeFields['financialInformation']['annualIncomeRange'];
  }
  if (questionId === 'step3.financial.netWorthExPrimaryResidenceRange') {
    next.financialInformation.netWorthExPrimaryResidenceRange = answer as InvestorProfileStepThreeFields['financialInformation']['netWorthExPrimaryResidenceRange'];
  }
  if (questionId === 'step3.financial.liquidNetWorthRange') {
    next.financialInformation.liquidNetWorthRange = answer as InvestorProfileStepThreeFields['financialInformation']['liquidNetWorthRange'];
  }
  if (questionId === 'step3.investment.knowledgeExperience') {
    next.investmentKnowledge = answer as InvestorProfileStepThreeFields['investmentKnowledge'];
  }
  if (questionId === 'step3.govId.photoId1') {
    next.governmentIdentification.photoId1 = answer as InvestorProfileStepThreeFields['governmentIdentification']['photoId1'];
  }
  if (questionId === 'step3.govId.photoId2') {
    next.governmentIdentification.photoId2 = answer as InvestorProfileStepThreeFields['governmentIdentification']['photoId2'];
  }

  if (questionId === 'step3.disclosure.relatedAdvisorFirmEmployee') {
  ...
  if (questionId === 'step3.disclosure.employeeBrokerDealer') {
    const payload = answer as {
      selection: YesNoMap;
  ...
  if (questionId === 'step3.disclosure.relatedBrokerDealerEmployee') {
    const payload = answer as {
      selection: YesNoMap;
  ...
  if (questionId === 'step3.disclosure.maintainsOtherBrokerageAccounts') {
    const payload = answer as {
      selection: YesNoMap;
  ...
  if (questionId === 'step3.disclosure.exchangeOrFinraAffiliation') {
    const payload = answer as {
      selection: YesNoMap;
  ...
  if (questionId === 'step3.disclosure.seniorOfficerDirectorTenPercentPublicCompany') {
    const payload = answer as {
      selection: YesNoMap;
  ...
  const investmentTypeKnowledge = getInvestmentTypeFromQuestionId(questionId, 'knowledge');
  if (investmentTypeKnowledge) {
    next.investmentKnowledge.byType[investmentTypeKnowledge].knowledge = answer as InvestorProfileStepThreeFields['investmentKnowledge']['general'];
  }
...
export function InvestorProfileStep3Page() {
  ...
  const [fields, setFields] = useState<InvestorProfileStepThreeFields>(createEmptyStep3Fields());
  const [visibleQuestionIds, setVisibleQuestionIds] = useState<InvestorProfileStepThreeQuestionId[]>([]);
  const [currentQuestionId, setCurrentQuestionId] = useState<InvestorProfileStepThreeQuestionId | null>(null);
  ...
  useEffect(() => {
    ...
    const loadStep = async () => {
      ...
      try {
        const response = await apiRequest<InvestorProfileStepThreeResponse>(
          `/api/clients/${clientId}/investor-profile/step-3`
        );
        ...
        setError('Unable to load Step 3 right now. Please try again.');
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleSubmit = async (event: FormEvent) => {
    ...
    const payload: InvestorProfileStepThreeUpdateRequest = {
    ...
    try {
      ...
      if (isStillLastQuestion) {
        pushToast('Step 3 saved.');
        if (response.onboarding.step.requiresStep4) {
          navigate(`/clients/${clientId}/investor-profile/step-4`, { replace: true });
        } else {
  ...
  const renderCountryPicker = () => {
    ...
    const singleCountry =
      currentQuestionId === 'step3.holder.legalAddress.country' ||
      currentQuestionId === 'step3.holder.mailingAddress.country' ||
      currentQuestionId === 'step3.holder.employment.employerAddress.country' ||
      (currentQuestionId === 'step3.holder.citizenship.primary' && !isPersonHolder);
  ...
  const renderPhonesBlock = () => {
    const answer = currentAnswer as InvestorProfileStepThreeFields['holder']['contact']['phones'];
  ...
  const renderAddressBlock = () => {
    const answer = currentAnswer as InvestorProfileStepThreeFields['holder']['legalAddress'];
    const isLegalAddress = currentQuestionId === 'step3.holder.legalAddress';
  ...
  const renderInvestmentKnowledgeBlock = () => {
    const answer = currentAnswer as InvestorProfileStepThreeFields['investmentKnowledge'];

    const getSelection = (map: InvestorProfileStepThreeFields['investmentKnowledge']['general']) =>
  ...
  const dynamicTitle =
    currentQuestionId === 'step3.holder.citizenship.primary'
      ? isPersonHolder
        ? 'Primary citizenship(s)?'
        : 'Primary country of formation?'
      : currentQuestionId === 'step3.holder.citizenship.additional'
        ? isPersonHolder
        ...
        <header className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <button
              ...
              type="button"
              onClick={() => navigate(clientId ? `/clients/${clientId}/investor-profile/step-2` : '/dashboard')}
            >
              Back to Step 2
            </button>
            <button
